...
namespace Studomat.DAL.Migrations
{
    ...
    [Migration("20201009124539_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Studomat.MODEL.Smjer", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Studomat.MODEL.Student", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Studomat.MODEL.Kolegij", b =>
                {
                    ...
                    b.HasOne("Studomat.MODEL.Smjer", "Smjer")
                        .WithMany("Kolegiji")
            ...
            modelBuilder.Entity("Studomat.MODEL.Ocjene", b =>
                {
                    ...
                    b.HasOne("Studomat.MODEL.Student", "Student")
                        .WithMany("Ocjene")
